...
const delay = ms => new Promise(res => setTimeout(res, ms));
    ...
    async function loadGraph(){
        let anchoa=criticos;
    var data = {
    labels: ['Maricopa', 'Orange', 'Napa', 'Los Angeles', 'Polk', 'Washington', 'Snoomish'],
    series: [
    casos,
    recovered
...
<main style=" background-color:#ffff9e ;" >

    <h5 id = "titulo" class = "titulo" >
       Número de Casos de Covid por condado.
    </h5>
             
           <div>   <Button outline style=" background-color:red; color:white" on:click="{pop}"> Volver</Button></div>   
    <div id = "todo" class = "todo">
       
        <div   id = "chart" class = "chart">
            <div class="ct-chart ct-perfect-fourth" ></div>
        </div>
        <p style="font-size: 120%;">La barra en ROJO oscuro el numero de casos. El ROJO CLARO muestra el nº de muertes. </p>
    </div>
